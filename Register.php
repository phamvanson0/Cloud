...
if(isset($_POST['btnRegister'])){	
	...
	if($err!= ""){
        ...
        $pass = md5($pass1);
        $sq = "SELECT * FROM staff WHERE  Username = '$us' OR email = '$email'";
        $res = mysqli_query($conn,$sq);
        if(mysqli_num_rows($res)==0){
            mysqli_query($conn,"INSERT INTO staff(Username,Password, StaName,gender,Address,telephone,email, StaDate,StaMonth,StaYear,SSN,ActiveCode,state)
